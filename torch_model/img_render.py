...
# np.save('./ray_origins', rays_origins)
# np.save('./rays_dirs', rays_dirs)
...
# np.save(folder + "s0_valid_rays_origins", valid_rays_origins)
# np.save(folder + "s1_valid_rays_dirs", valid_rays_dirs)
# np.save(folder + "s2_valid_tmin", valid_tmin)
# np.save(folder + "s3_valid_tmin", valid_tmin)


# print("shape of rays to render:", valid_rays_origins.shape)
# rendered_rays, sh_batched = rf.render_rays(valid_rays_origins, valid_rays_dirs, valid_tmin, valid_tmax, batch_size)
# rendered_rays = rendered_rays.numpy()
# sh_batched = sh_batched.numpy()
# np.save('./sh_batched', sh_batched)
